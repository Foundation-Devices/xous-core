...
// TODO This is a placeholder for a system that can be used to stream updates
// back to the caller so that notifications can be shown.
// TODO I'm not entirely sure if this is needed yet and whether or not it's the right thing to do
struct Updates;

impl Updates {
    fn send_update(_comment: &str) {
        todo!()
    }
}
